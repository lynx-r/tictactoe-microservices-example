...
public class SpringSecurityWebFluxConfig {
  ...
  public SpringSecurityWebFluxConfig(
    ...
    this.reactiveAuthenticationManager = new UserDetailsRepositoryReactiveAuthenticationManager(userDetailsRepositoryInMemory);
  }
  ...
  public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http, JwtService jwtService) {
    ...
    http
        ...
        .authenticated()
        .and()
        .addFilterAt(new WebApiJwtAuthWebFilter(reactiveAuthenticationManager, jwtService), SecurityWebFiltersOrder.HTTP_BASIC)
        .exceptionHandling();
